var BASIS = (() => {
    ...
    return (function (moduleArg = {}) {
        ...
        function findWasmBinary() { var f = "basis_encoder.wasm"; if (!isDataURI(f)) {
            return locateFile(f);
        } return f; }
        var wasmBinaryFile;
        ...
        function createJsInvoker(argTypes, isClassMethodFunc, returns, isAsync) { var needsDestructorStack = usesDestructorStack(argTypes); var argCount = argTypes.length; var argsList = ""; var argsListWired = ""; for (var i = 0; i < argCount - 2; ++i) {
            argsList += (i !== 0 ? ", " : "") + "arg" + i;
        ...
        } registerType(rawType, { name: name, fromWireType: value => { var length = HEAPU32[value >> 2]; var str; var decodeStartPtr = value + 4; for (var i = 0; i <= length; ++i) {
        ...
        var __emval_get_module_property = name => { name = getStringOrSymbol(name); return Emval.toHandle(Module[name]); };
        ...
        init_emval();
        var wasmImports = { v: ___cxa_throw, C: ___syscall_fcntl64, S: ___syscall_fstat64, U: ___syscall_ioctl, Q: ___syscall_newfstatat, D: ___syscall_openat, R: ___syscall_stat64, X: __abort_js, t: __embind_finalize_value_object, J: __embind_register_bigint, aa: __embind_register_bool, x: __embind_register_class, w: __embind_register_class_constructor, a: __embind_register_class_function, e: __embind_register_constant, $: __embind_register_emval, n: __embind_register_enum, b: __embind_register_enum_value, F: __embind_register_float, j: __embind_register_function, m: __embind_register_integer, g: __embind_register_memory_view, E: __embind_register_std_string, z: __embind_register_std_wstring, u: __embind_register_value_object, d: __embind_register_value_object_field, ba: __embind_register_void, W: __emscripten_memcpy_js, N: __emscripten_throw_longjmp, o: __emval_as, q: __emval_call, p: __emval_call_method, c: __emval_decref, A: __emval_get_global, k: __emval_get_method_caller, r: __emval_get_module_property, h: __emval_get_property, l: __emval_incref, i: __emval_new_cstring, f: __emval_run_destructors, G: __mmap_js, H: __munmap_js, K: __tzset_js, V: _emscripten_date_now, O: _emscripten_get_heap_max, P: _emscripten_resize_heap, L: _environ_get, M: _environ_sizes_get, y: _fd_close, T: _fd_read, I: _fd_seek, B: _fd_write, Z: invoke_ii, s: invoke_vi, Y: invoke_vii, _: invoke_viii };
        ...
        var _emscripten_builtin_memalign = (a0, a1) => (_emscripten_builtin_memalign = wasmExports["ia"])(a0, a1);
        ...
        var _emscripten_stack_get_current = () => (_emscripten_stack_get_current = wasmExports["la"])();
        var ___cxa_is_pointer_type = a0 => (___cxa_is_pointer_type = wasmExports["ma"])(a0);
        var dynCall_ji = Module["dynCall_ji"] = (a0, a1) => (dynCall_ji = Module["dynCall_ji"] = wasmExports["na"])(a0, a1);
        var dynCall_iij = Module["dynCall_iij"] = (a0, a1, a2, a3) => (dynCall_iij = Module["dynCall_iij"] = wasmExports["oa"])(a0, a1, a2, a3);
        var dynCall_jiiii = Module["dynCall_jiiii"] = (a0, a1, a2, a3, a4) => (dynCall_jiiii = Module["dynCall_jiiii"] = wasmExports["pa"])(a0, a1, a2, a3, a4);
        var dynCall_jiji = Module["dynCall_jiji"] = (a0, a1, a2, a3, a4) => (dynCall_jiji = Module["dynCall_jiji"] = wasmExports["qa"])(a0, a1, a2, a3, a4);
        var dynCall_viijii = Module["dynCall_viijii"] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_viijii = Module["dynCall_viijii"] = wasmExports["ra"])(a0, a1, a2, a3, a4, a5, a6);
        var dynCall_iiiiij = Module["dynCall_iiiiij"] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_iiiiij = Module["dynCall_iiiiij"] = wasmExports["sa"])(a0, a1, a2, a3, a4, a5, a6);
        var dynCall_iiiiijj = Module["dynCall_iiiiijj"] = (a0, a1, a2, a3, a4, a5, a6, a7, a8) => (dynCall_iiiiijj = Module["dynCall_iiiiijj"] = wasmExports["ta"])(a0, a1, a2, a3, a4, a5, a6, a7, a8);
        var dynCall_iiiiiijj = Module["dynCall_iiiiiijj"] = (a0, a1, a2, a3, a4, a5, a6, a7, a8, a9) => (dynCall_iiiiiijj = Module["dynCall_iiiiiijj"] = wasmExports["ua"])(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9);
