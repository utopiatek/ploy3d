...
override QUALITY_USE_GEOMETRIC_SPECULAR_AA = true;
override QUALITY_USE_ALPHA_TO_COVERAGE = true;

override SHADING_MODEL = 1u;
override SHADING_TYPE_SHADOW: bool = false;
override SHADING_AS_UNLIT: bool = true;
override SHADING_AS_CLOTH: bool = false;
...
override MATERIAL_HAS_REFRACTION = false;
override MATERIAL_HAS_IOR = false;
override MATERIAL_HAS_SHEENCOLOR = false;
override MATERIAL_HAS_CLEAR_COAT = false;
override MATERIAL_HAS_CLEAR_COAT_IOR_CHANGE = false;
...
fn save_override() ->u32 {
    ...
    let QUALITY_USE_GEOMETRIC_SPECULAR_AA_ = QUALITY_USE_GEOMETRIC_SPECULAR_AA;
    let QUALITY_USE_ALPHA_TO_COVERAGE_ = QUALITY_USE_ALPHA_TO_COVERAGE;

    let SHADING_MODEL_ = SHADING_MODEL;
    let SHADING_TYPE_SHADOW_ = SHADING_TYPE_SHADOW;
    let SHADING_AS_UNLIT_ = SHADING_AS_UNLIT;
    let SHADING_AS_CLOTH_ = SHADING_AS_CLOTH;
    ...
    let MATERIAL_HAS_REFRACTION_ = MATERIAL_HAS_REFRACTION;
    let MATERIAL_HAS_IOR_ = MATERIAL_HAS_IOR;
    let MATERIAL_HAS_SHEENCOLOR_ = MATERIAL_HAS_SHEENCOLOR;
    let MATERIAL_HAS_CLEAR_COAT_ = MATERIAL_HAS_CLEAR_COAT;
    let MATERIAL_HAS_CLEAR_COAT_IOR_CHANGE_ = MATERIAL_HAS_CLEAR_COAT_IOR_CHANGE;
