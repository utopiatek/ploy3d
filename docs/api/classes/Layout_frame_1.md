...
[Ploy3D](../README.md) / Layout\_frame\_1

# Class: Layout\_frame\_1
...
### new Layout\_frame\_1()

> **new Layout\_frame\_1**(`system`, `canvas`, `id`, `options`): [`Layout_frame_1`](Layout_frame_1.md)
...
> `static` **designs**: `Record`\<`string`, `object`\>
