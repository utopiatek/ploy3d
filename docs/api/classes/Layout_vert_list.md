...
[Ploy3D](../README.md) / Layout\_vert\_list

# Class: Layout\_vert\_list
...
### new Layout\_vert\_list()

> **new Layout\_vert\_list**(`system`, `canvas`, `id`, `options`): [`Layout_vert_list`](Layout_vert_list.md)
